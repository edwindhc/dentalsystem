...
const links = [
  { name: 'Resumen', href: '/panel' },
  { name: 'Clientes', href: '/panel/clientes' },
  { name: 'Usuarios', href: '/panel/usuarios' },
];
        ...
        <div className='px-3 py-3 lg:px-5 lg:pl-3'>
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center'>
              {/* User Avatar */}
              <div
                className='flex h-12 w-12 cursor-pointer items-center justify-center rounded-full bg-blue-500 p-2 text-white'
                onClick={() => {
